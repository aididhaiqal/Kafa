                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('admin.parents.index')} active={route().current('admin.parents.index')}>
                                    Parents
                                </NavLink>
                                <NavLink href={route('admin.students.index')} active={route().current('admin.students.index')}>
                                    Students
                                </NavLink>
                                </>
                                )}
                                ...
                                {user && user.role === 'teacher' && (
                                    <>
                                <NavLink href={route('teacher.students.index')} active={route().current('teacher.students.index')}>
                                    Students
                                </NavLink>

    ...
    const handleDelete = (id) => {
        if (confirmDelete) {
            if (window.confirm('Are you sure you want to delete this student?')) {
                Inertia.delete(route('students.delete', id));
            }
        } else {
            Inertia.delete(route('students.delete', id));
        }
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div className="p-6 bg-white border-b border-gray-200">
                        <h2 className="font-semibold text-xl text-gray-800 leading-tight mb-4">Student Registrations</h2>
                                        ...
                                        {students.length > 0 ? (
                                            students.map((student) => (
                                                <tr key={student.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <Link href={route('students.edit', student.id)} className="text-indigo-600 hover:text-indigo-900">
                                                            Edit
                                                        </Link>
                                            ...
                                            <tr>
                                                <td colSpan="5" className="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                                    {/* Intentionally left empty to show table structure */}
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
